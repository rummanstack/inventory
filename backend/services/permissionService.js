...
export const PERMISSION_REQUIRED_FEATURES = {
  ...
  view_installment_plans: ["installment-plans", "installment-reports", "installment-dashboard", "installment-late-fee-rules"],
  manage_installment_plans: ["installment-plans", "installment-late-fee-rules"],
  collect_installment_payment: "installment-plans",
  reschedule_installment_plan: "installment-plans",
  cancel_installment_plan: "installment-plans",
  write_off_installment_plan: "installment-plans",
  override_installment_credit_limit: "installment-plans",
  manage_installment_credit_settings: "installment-plans",
  ...
  view_trade_promotions: ["trade-promotion-rules", "trade-promotion-earnings", "trade-promotion-settlements", "trade-promotion-reports"],
  manage_trade_promotion_rules: "trade-promotion-rules",
  manage_trade_promotion_settlements: "trade-promotion-settlements",
  ...
  view_expiry_alerts: ["retailer-sales-invoices", "expiry-alerts"],
  manage_batch_tracking: "batch-sales-report",

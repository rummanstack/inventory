        ...
        <div className="landing-container grid items-center gap-10 lg:grid-cols-[1fr_0.9fr]">
          <div>
            <div className="flex items-center gap-2 text-sm font-bold text-white/70">
              ...
              <span>/</span>
              <Link to={buildLocalizedPath(language, isFeature ? '/features' : '/solutions')} className="transition hover:text-white">{isFeature ? t('seoContent.breadcrumbFeatures') : t('seoContent.breadcrumbSolutions')}</Link>
            </div>
            <div className="mt-6 max-w-3xl">

...
import { LayoutGrid, Loader2, Pencil, Plus, Save } from 'lucide-react';
            ...
            <tbody className="divide-y divide-slate-100">
              {tenants.map((tenant) => (
                <tr key={tenant.id} className="hover:bg-slate-50/50">
                  ...
                  <td className="px-4 py-3 text-right">
                    <button type="button" className="icon-btn" title={t('organizations.featuresTitle')} onClick={() => setFeaturesTenant(tenant)}>
                      <LayoutGrid size={16} />
                    </button>
                  </td>
                  <td className="px-4 py-3 text-right">
